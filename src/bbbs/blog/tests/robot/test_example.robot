...
#
#  $ bin/test -s bbbs.blog -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src bbbs.blog.testing.BBBS_BLOG_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/bbbs/blog/tests/robot/test_example.robot
#
